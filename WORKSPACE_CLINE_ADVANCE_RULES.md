...
>
> - **LIVE_MCP_SERVER** = `<your-live-memory-mcp-server-name>`
> - **SPACE** = `<your-live-memory-space-id>`
> - **GRAPH_MCP_SERVER** = `<your-graph-memory-mcp-server-name>`
> - **GRAPH_MEMORY_ID** = `<your-graph-memory-id>`
>
